...
// Lagring av bindkeys kopplade till MAC-adresser
std::map<std::string, std::string> victronKeys;
...
// 3. Starta BLE-skanningen på Core 0 (Radio-kärnan)
xTaskCreatePinnedToCore(
    bleTask,        // Funktion som ska köras
    "BLE_Task",     // Namn på uppgiften
    4096,           // Stackstorlek i bytes
    NULL,           // Parametrar
    1,              // Prioritet
    NULL,           // Task handle
    0               // Körs på Core 0
